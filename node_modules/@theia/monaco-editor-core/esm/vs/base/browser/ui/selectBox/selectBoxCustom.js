...
class SelectBoxList extends lifecycle_1.Disposable {
    ...
    createSelectList(parent) {
        ...
        this._register(onSelectDropDownKeyDown.filter(e => e.keyCode === 2 /* Tab */).on(e => this.onEnter(e), this)); // Tab should behave the same as enter, #79339
        ...
        this._register(onSelectDropDownKeyDown.filter(e => (e.keyCode >= 21 /* Digit0 */ && e.keyCode <= 56 /* KeyZ */) || (e.keyCode >= 80 /* Semicolon */ && e.keyCode <= 108 /* NumpadDivide */)).on(this.onCharacter, this));
