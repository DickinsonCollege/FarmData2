...
exports.ResolvedLanguageConfiguration = exports.LanguageConfigurationRegistry = exports.LanguageConfigurationRegistryImpl = exports.LanguageConfigurationChangeEvent = exports.LanguageConfigurationService = exports.ILanguageConfigurationService = exports.LanguageConfigurationServiceChangeEvent = void 0;
...
let LanguageConfigurationService = class LanguageConfigurationService extends lifecycle_1.Disposable {
    constructor(configurationService, languageService) {
        ...
        this._register(exports.LanguageConfigurationRegistry.onDidChange((e) => {
...
function computeConfig(languageId, configurationService, languageService) {
    let languageConfig = exports.LanguageConfigurationRegistry.getLanguageConfiguration(languageId);
    if (!languageConfig) {
...
class LanguageConfigurationRegistryImpl {
    ...
    getColorizedBracketPairs(languageId) {
        var _a;
        return ((_a = this.getLanguageConfiguration(languageId)) === null || _a === void 0 ? void 0 : _a.characterPair.getColorizedBrackets()) || [];
    }
}
