    ...
    read() {
        ...
        while (true) {
            ...
            if (this.lineTokenOffset < tokenCount) {
                ...
                const isOther = languages_1.TokenMetadata.getTokenType(tokenMetadata) === 0 /* Other */;
        ...
        return new Token(length, 0 /* Text */, -1, smallImmutableSet_1.SmallImmutableSet.getEmpty(), new ast_1.TextAstNode(length));
    }
}
class FastTokenizer {
    constructor(text, brackets) {
        ...
        for (let i = 0; i < 60; i++) {
            smallTextTokens0Line.push(new Token((0, length_1.toLength)(0, i), 0 /* Text */, -1, smallImmutableSet_1.SmallImmutableSet.getEmpty(), new ast_1.TextAstNode((0, length_1.toLength)(0, i))));
        }
        const smallTextTokens1Line = new Array();
        for (let i = 0; i < 60; i++) {
            smallTextTokens1Line.push(new Token((0, length_1.toLength)(1, i), 0 /* Text */, -1, smallImmutableSet_1.SmallImmutableSet.getEmpty(), new ast_1.TextAstNode((0, length_1.toLength)(1, i))));
        }
        if (regexp) {
            regexp.lastIndex = 0;
                    ...
                    if (lastTokenEndOffset !== curOffset) {
                        ...
                        if (lastTokenEndLine === curLineCount) {
                            ...
                            if (colCount < smallTextTokens0Line.length) {
                                ...
                                token = new Token(length, 0 /* Text */, -1, smallImmutableSet_1.SmallImmutableSet.getEmpty(), new ast_1.TextAstNode(length));
                            }
                        }
                        else {
        ...
        if (lastTokenEndOffset !== offset) {
            ...
            tokens.push(new Token(length, 0 /* Text */, -1, smallImmutableSet_1.SmallImmutableSet.getEmpty(), new ast_1.TextAstNode(length)));
        }
