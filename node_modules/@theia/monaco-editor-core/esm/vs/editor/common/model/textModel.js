...
let TextModel = class TextModel extends lifecycle_1.Disposable {
    constructor(source, languageId, creationOptions, associatedResource = null, _undoRedoService, _languageService, _languageConfigurationService) {
        ...
        this._tokenization = new textModelTokens_1.TextModelTokenization(this, this._languageService.languageIdCodec);
        this._bracketPairColorizer = this._register(new bracketPairsImpl_1.BracketPairsTextModelPart(this, this._languageConfigurationService));
    ...
    onDidChangeContentOrInjectedText(listener) {
        return (0, lifecycle_1.combinedDisposable)(this._eventEmitter.fastEvent(e => listener(e.rawContentChangedEvent)), this._onDidChangeInjectedText.event(e => listener(e)));
    }
