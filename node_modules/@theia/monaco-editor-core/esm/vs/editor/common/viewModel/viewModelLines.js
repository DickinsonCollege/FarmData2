            ...
            for (const viewLineInfo of group.viewLines) {
                if (viewLineInfo.isWrappedLineContinuation && this.getMinColumnOfViewLine(viewLineInfo) === 1) {
                    ...
                    bracketGuides = bracketGuides.map(g => g.horizontalLine ?
                        new textModelGuides_1.IndentGuide(g.visibleColumn, g.className, new textModelGuides_1.IndentGuideHorizontalLine(g.horizontalLine.top, this.convertModelPositionToViewPosition(viewLineInfo.modelLineNumber, g.horizontalLine.endColumn).column)) : g);
