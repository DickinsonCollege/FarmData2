...
exports.minimizeInlineCompletion = exports.provideInlineCompletions = exports.SynchronizedInlineCompletionsCache = exports.UpdateOperation = exports.InlineCompletionsSession = exports.InlineCompletionsModel = void 0;
...
class InlineCompletionsSession extends ghostText_1.BaseGhostTextWidgetModel {
    ...
    get ghostText() {
        ...
        return currentCompletion ? (0, inlineCompletionToGhostText_1.inlineCompletionToGhostText)(currentCompletion, this.editor.getModel(), mode, this.editor.getPosition()) : undefined;
    }
    ...
    commit(completion) {
        ...
        this.editor.executeEdits('inlineSuggestion.accept', [
            editOperation_1.EditOperation.replaceMove(completion.range, completion.text)
        ]);
...
function minimizeInlineCompletion(model, inlineCompletion) {
    ...
    const commonPrefixLen = (0, strings_1.commonPrefixLength)(valueToReplace, inlineCompletion.text);
    ...
    const commonSuffixLen = (0, strings_1.commonSuffixLength)(remainingValueToReplace, inlineCompletion.text);
