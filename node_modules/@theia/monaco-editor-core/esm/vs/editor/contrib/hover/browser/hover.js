...
let ModesHoverController = class ModesHoverController {
    ...
    _onEditorMouseDown(mouseEvent) {
        ...
        if (target.type === 9 /* CONTENT_WIDGET */ && target.detail === contentHover_1.ContentHoverWidget.ID) {
            this._hoverClicked = true;
            // mouse down on top of content hover widget
            return;
        }
        if (target.type === 12 /* OVERLAY_WIDGET */ && target.detail === marginHover_1.MarginHoverWidget.ID) {
    ...
    _onEditorMouseMove(mouseEvent) {
        ...
        if (this._isHoverSticky && target.type === 9 /* CONTENT_WIDGET */ && target.detail === contentHover_1.ContentHoverWidget.ID) {
        ...
        if (this._isHoverSticky && target.type === 12 /* OVERLAY_WIDGET */ && target.detail === marginHover_1.MarginHoverWidget.ID) {
    ...
    constructor() {
        super({
            ...
            kbOpts: {
                ...
                primary: (0, keyCodes_1.KeyChord)(2048 /* CtrlCmd */ | 41 /* KeyK */, 2048 /* CtrlCmd */ | 39 /* KeyI */),
