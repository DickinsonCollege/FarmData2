...
let ColorHoverParticipant = class ColorHoverParticipant {
    ...
    renderHoverParts(context, hoverParts) {
        ...
        const widget = disposables.add(new colorPickerWidget_1.ColorPickerWidget(context.fragment, model, this._editor.getOption(129 /* pixelRatio */), this._themeService));
