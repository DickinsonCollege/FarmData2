...
let SuggestModel = class SuggestModel {
    ...
    _doTriggerQuickSuggest() {
        ...
        if (this._editor.getOption(106 /* suggest */).snippetsPreventQuickSuggestions && ((_a = snippetController2_1.SnippetController2.get(this._editor)) === null || _a === void 0 ? void 0 : _a.isInSnippet())) {
    ...
    trigger(context, retrigger = false, onlyFrom, existing) {
        ...
        const completions = (0, suggest_1.provideSuggestionItems)(this._languageFeaturesService.completionProvider, model, this._editor.getPosition(), new suggest_1.CompletionOptions(snippetSortOrder, itemKindFilter, onlyFrom, showDeprecated), suggestCtx, this._requestToken.token);
