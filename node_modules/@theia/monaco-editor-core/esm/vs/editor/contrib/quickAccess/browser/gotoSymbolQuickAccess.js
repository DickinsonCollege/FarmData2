...
const NLS_SYMBOL_KIND_CACHE = {
    [5 /* Method */]: (0, nls_1.localize)('method', "methods ({0})"),
    [11 /* Function */]: (0, nls_1.localize)('function', "functions ({0})"),
    [8 /* Constructor */]: (0, nls_1.localize)('_constructor', "constructors ({0})"),
    [12 /* Variable */]: (0, nls_1.localize)('variable', "variables ({0})"),
    [4 /* Class */]: (0, nls_1.localize)('class', "classes ({0})"),
    [22 /* Struct */]: (0, nls_1.localize)('struct', "structs ({0})"),
    [23 /* Event */]: (0, nls_1.localize)('event', "events ({0})"),
    [24 /* Operator */]: (0, nls_1.localize)('operator', "operators ({0})"),
    [10 /* Interface */]: (0, nls_1.localize)('interface', "interfaces ({0})"),
    [2 /* Namespace */]: (0, nls_1.localize)('namespace', "namespaces ({0})"),
    [3 /* Package */]: (0, nls_1.localize)('package', "packages ({0})"),
    [25 /* TypeParameter */]: (0, nls_1.localize)('typeParameter', "type parameters ({0})"),
    [1 /* Module */]: (0, nls_1.localize)('modules', "modules ({0})"),
    [6 /* Property */]: (0, nls_1.localize)('property', "properties ({0})"),
    [9 /* Enum */]: (0, nls_1.localize)('enum', "enumerations ({0})"),
    [21 /* EnumMember */]: (0, nls_1.localize)('enumMember', "enumeration members ({0})"),
    [14 /* String */]: (0, nls_1.localize)('string', "strings ({0})"),
    [0 /* File */]: (0, nls_1.localize)('file', "files ({0})"),
    [17 /* Array */]: (0, nls_1.localize)('array', "arrays ({0})"),
    [15 /* Number */]: (0, nls_1.localize)('number', "numbers ({0})"),
    [16 /* Boolean */]: (0, nls_1.localize)('boolean', "booleans ({0})"),
    [18 /* Object */]: (0, nls_1.localize)('object', "objects ({0})"),
    [19 /* Key */]: (0, nls_1.localize)('key', "keys ({0})"),
    [7 /* Field */]: (0, nls_1.localize)('field', "fields ({0})"),
    [13 /* Constant */]: (0, nls_1.localize)('constant', "constants ({0})")
};
//#endregion
