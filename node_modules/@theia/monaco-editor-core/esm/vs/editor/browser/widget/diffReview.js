...
let DiffReview = class DiffReview extends lifecycle_1.Disposable {
    ...
    _render() {
        ...
        (0, domFontInfo_1.applyFontInfo)(container, modifiedOptions.get(44 /* fontInfo */));
