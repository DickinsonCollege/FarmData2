...
1. Create a test your form using the [Cypress testing framework](https://www.cypress.io/) by creating a new `spec.js` file in `cypress\integration` directory.
...
1. Run all of the tests using `./cypress_run.bash`
