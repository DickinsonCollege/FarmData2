...
if [ -z "$FD2GRP_EXISTS" ];
then
  echo "  fd2grp group does not exist on host."
else
...
if [ -z "$USER_IN_FD2GRP" ];
then
  echo "  User $(id -un) is not in fd2grp group."
else
...
then
  echo "  $FD2_DIR is not in fd2grp group."
else
...
if [ -z "$FD2GRP_RW_FD2" ];
then
  echo "  fd2grp does not have RW access to $FD2_DIR."
else
